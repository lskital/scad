...
hole2 = 10;
hole2_depth = 1.6;
hole2_tr = 0.5*(thickness - hole2_depth);

difference() {
  gear(8.0, 8, thickness, hole1);
  translate([0, 0, hole2_tr]) cylinder(h=hole2_depth, d=hole2, center=true);
}

//translate([0, 0, -2]) color([1.00,0.75,0.75]) cylinder(d=15.4, h=thickness, center=true);
//translate([0, 0, 2]) color([0.75,1.00,0.75]) cylinder(d=25.6, h=thickness, center=true);
